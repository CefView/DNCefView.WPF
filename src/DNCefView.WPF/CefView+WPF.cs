...
namespace DNCefView.WPF
{
    ...
    public partial class CefView : FrameworkElement
    {
        ...
        {
            byte[] frameBuffer = new byte[imageBytesCount];
            Marshal.Copy(imageBytesBuffer, frameBuffer, 0, imageBytesCount);
            ...
            void Paint()
            {
                ...
                int stride = width * 4;
                targetBitmap.WritePixels(rect, frameBuffer, stride, 0);
